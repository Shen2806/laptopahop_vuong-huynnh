...
import {
    getCreateUserPage, getHomePage, getProductFilterPage, getViewUser,
    postCreateUser, postDeleteUser, postUpdateUser,
    getRegisterPage, updateProfilePage, handleUpdateProfile,
    postCancelOrderByUser, getUserOrders, postChangePassword
} from '../controllers/user.controller';
import 'dotenv/config';
import {
    getAdminOrderDetailPage, getAdminOrderPage, getAdminProductPage, getAdminUserPage,
    getDashboardPage, getPromoPage, postAddPromo, postCancelOrderByAdmin,
    postConfirmOrder, postDeletePromo, postRestockProduct,
    postUpdateOrderStatus, postUpdatePromo
} from '../controllers/admin/dashboard.controller';
import fileUploadMiddleware from '../middleware/multer';
import {
    getCartPage, getCheckOutPage, getOrderDetailPage, getOrderHistoryPage,
    getProductPage, getThanksPage, postAddProductToCart, postAddToCartFromDetailPage,
    postDeleteProductInCart, postHandleCartToCheckOut, postPlaceOrder
} from '../controllers/client/product.controller';
import {
    getAdminCreateProductPage, getViewProduct, postAdminCreateProduct,
    postDeleteProduct, postUpdateProduct
} from '../controllers/admin/product.controller';
import {
    getAboutUsPage, getContactPage, getLoginPage, getPrivacyPage, getReturnPage,
    getSuccessRedirectPage, getSupportPage, getTermPage, getWarrantyPage,
    postLogin, postLogout, postRegister, refreshToken
} from '../controllers/client/auth.controller';
import passport from 'passport';
import { ensureAuthenticated, isAdmin, isAdminOrStaff, isLogin } from '../middleware/auth';
import multer from 'multer';
import { prisma } from '../config/client';
import {
    getAdminBlogPage, getAdminCreateBlogPage, getAdminEditBlogPage,
    postAdminCreateBlog, postAdminUpdateBlog, postDeleteBlog
} from '../controllers/admin/blog.controller';
import { getBlogDetailPage, getBlogListPage } from '../controllers/client/blog.controller';
import {
    deleteCoupon, getCoupons, getCreateCoupon, getEditCoupon,
    postCreateCoupon, postEditCoupon
...
import {
    adminInventoryAdjustAPI, adminInventoryListAPI, adminInventoryPage, adminInventorySetReorderAPI
} from '../controllers/admin/inventory.controller';
import { getComparePage } from '../controllers/client/compare.controller';
import {
    getAdminStaffPage, getCreateStaffPage, getViewStaff, postCreateStaff, postDeleteStaff, postUpdateStaff
...
const webRoutes = (app: Express) => {
    ...
    // Controller-based review routes
    ...
    // Admin chat (duplicated theo bản gốc của bạn)
