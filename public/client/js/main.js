...
/* Dùng event ủy quyền + ép button type=button để không submit form */
$(document).off('click.addHome', '.btnAddToCartHomePage')
.on('click.addHome', '.btnAddToCartHomePage', function (event) {
